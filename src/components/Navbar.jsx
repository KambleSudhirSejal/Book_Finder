...
const Navbar = ({handleSearch}) => {
  ...
  return (
    <nav
      className="sticky top-0 z-50 bg-gray-900/95 backdrop-blur-2xl border-b
        ...
        >
          ...
          >
            <div className="bg-gray-900/80 backdrop-blur-sm rounded-xl p-2">
              <h1
                className="text-lg md-text-2xl font-bold bg-gradient-to-r from-cyan-400
              ...
              <div className="relative group">
                ...
                <div className="relative dynamic-gradient">
                  <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 md:pl-4">
                    <MagnifyingGlassIcon className="h-5 w-5 md:h-6 text-cyan-300 drop-shadow-glow z-10" />
                  </div>
                  <input
                    type="text"
                    value={searchTerm}
                    ...
                    className="block w-full rounded-2xl border border-gray-700/50 
                         bg-gray-900/60 py-2 md:py-3 pl-10 md:pl-12 pr-4 md:pr-6 text-sm md:text-base text-gray-100
                         placeholder-gray-100 focus:outline-none focus:border-cyan-300/50 focus:ring2 focus:ring-cyan-300/30
                         backdrop-blur-xl shadow-xl transition-all duration-300 hover-bg-gray-900/80"
                  />
                </div>
              </div>
            </form>
          ...
          <div className="flex items-center space-x-4 order-2 md:order-3 ml-auto md:ml-0">
            <button className="relative p-1 group hover:scale-105 transition-transform">
              <div
                className="absolute -inset-1 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full
              ...
              <div
                className="absolute -top-1 -right-1 h-2 w-2 md:h-3 md:w-3 bg-cyan-400 rounded-full
              shadow-glow-pulse"
              />
            </button>
          </div>
