        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
          ...
          <div className="lg:col-span-1 flex flex-col justify-center space-y-6">
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-r from-cyan-400
          ...
          {/* Image  Container */}
          <div
            className="md:col-span-1 lg:col-span-2 h-64 sm:h-80 md:h-[600px] lg:h-[700px] relative
